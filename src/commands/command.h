...
public:
  Command(std::string const &&name, DataHandler &handler,
          Serializer &serializer, Viewer &viewer)
  ...
  make_command(DataHandler &handler, Serializer &serializer, Viewer &viewer) {
